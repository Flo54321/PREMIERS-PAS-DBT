...
# Encoder le mot de passe pour qu'il soit compatible avec l'URL
encoded_password = quote_plus(password)


# On créée la connexion vers la base de données.

DATABASE_URI = f'mysql+pymysql://{username}:{encoded_password}@{host}:{port}/{database}'
